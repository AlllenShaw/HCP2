...
<div id="header">
	...
	<div id="persion">
		...
		<label id="pb">${username}</label> <input type="hidden"
			id="loginuserid" value="${userid}"><input type="hidden"
	...
	<div class="menu">
		<ul class="list">
			<li><a id="m1" href="javascript:void(0)"
				onclick="mainmenu('patient/index.do')">首&nbsp;&nbsp;页</a>
			</li>
			<li><a id="m3" href="javascript:void(0)"
				onclick="mainmenu('patient/xieTongZhenZhi.do')">电子档案</a>
			</li>
			<li><a id="m4" href="javascript:void(0)"
				onclick="mainmenu('patient/sangaoyuce.do')">三高预测</a>
			</li>
			<li><a id="m7" href="javascript:void(0)"
				onclick="mainmenu('patient/pingtaizhicheng.do')">平台支撑</a></li>
			<li><a id="m8" href="javascript:void(0)"
				onclick="mainmenu('user/logout.do')">注销</a></li>
		</ul>
	</div>
	<!-- 
	<div class="menu">
		<ul class="list">
			...
			<li><a id="m8" href="javascript:void(0)"
				onclick="mainmenu('doctor/logout.do')">注销</a>
			</li>
		</ul>
	</div> -->
</div>