				...
				<div id="outpat">
					<div id="pat">
						...
						<form id="register_hmanager" name="register_hmanager"
							action="superAdmin/addHospitalAdmin.do" method="post" onsubmit="">
							<table border="0" cellspacing="5px" cellpadding="2px"
								align="center">
								<tr>
								...
								<tr>
									...
									<td class="td_3"><input type="text" id="id2" name="idNumber"
								...
								<tr>
									...
									<td class="td_3"><input type="text" id="mail" name="mail"
										onblur="checkemail()"> <span id="tipmail"
										data-tipso=""></span></td>
								</tr>
							</table>
							<div class="fbl2">
