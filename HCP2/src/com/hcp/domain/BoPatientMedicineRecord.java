...
/**
 * BoPatientMedicineRecord entity. @author MyEclipse Persistence Tools
 */

public class BoPatientMedicineRecord implements java.io.Serializable {
	...
	/** default constructor */
	public BoPatientMedicineRecord() {
	}

	/** full constructor */
	public BoPatientMedicineRecord(Medicine medicine, TakingMedicineWay takingMedicineWay, MedicineUnit medicineUnit,
